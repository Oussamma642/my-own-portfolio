  ...
  const projects = [
    {
      ...
      projectDemoLinkdine:
        "https://www.linkedin.com/posts/azzedine-rih-a284b02a0_daezveloppementweb-laravel-reactjs-ugcPost-7342252894135496704-iukz?utm_source=share&utm_medium=member_desktop&rcm=ACoAAFRr3s0BqxrX5Ub5RpNmesdbcHMBVgfzN10",
    },
    {
      id: 2,
      ...
      projectDemoLinkdine:
        "https://www.linkedin.com/posts/oussama-ait-mohamed-239402336_daezveloppementweb-laravel-reactjs-activity-7336102076525010946-5b5k?utm_source=share&utm_medium=member_desktop&rcm=ACoAAFRr3s0BqxrX5Ub5RpNmesdbcHMBVgfzN10",
    },
    {
      id: 3,
      ...
      projectDemoLinkdine:
        "https://github.com/Oussamma642/contact-management-system",
    },
  ];
    ...
    try {
      ...
      await emailjs.send(
        ...
        import.meta.env.VITE_EMAILJS_TEMPLATE_ID,
        {
          ...
          to_email: "aitmohamedoussama57@gmail.com", // Replace with your email
        },
                      ...
                      <div className="absolute inset-0 bg-slate-900/75 lg:hidden flex flex-col justify-center items-center text-center p-4 min-h-full">
                        <div className="flex flex-col justify-center items-center h-full max-w-full">
                          ...
                          <div className="flex gap-4">
                            ...
                            <div className="w-6 h-6 text-white hover:text-indigo-400 transition-colors duration-200">
                              <a
                                href={project.projectDemoLinkdine}
                                target="_blank"
                                rel="noopener noreferrer"
                              >
                    ...
                    <div className="text-center lg:text-left">
                      ...
                      <div className="flex gap-4 justify-center lg:justify-start">
                        {project.demo && (
                          ...
                          >
                            <SiGithub className="inline-block mr-2 w-4 h-4" />
                            Source Code
                          </a>
                        )}
                        {project.projectDemoLinkdine && (
                          <a
                            href={project.projectDemoLinkdine}
                            target="_blank"
                            rel="noopener noreferrer"
                      ...
                      <div className="bg-slate-900/95 p-6 rounded-lg shadow-md md:ml-0">
                        ...
                        <h3 className="font-semibold text-indigo-400 mb-1">
                          <a
                            target="_blank"
                            href={item.link}
                            className="underline hover:text-indigo-300 transition-colors cursor-pointer inline-flex items-center gap-2"
                            title="Open link"
                          >
                            {item.title}
