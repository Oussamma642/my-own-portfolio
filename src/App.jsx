  ...
  const projects = [
    {
      ...
      projectDemoLinkdine:"https://www.linkedin.com/posts/azzedine-rih-a284b02a0_daezveloppementweb-laravel-reactjs-ugcPost-7342252894135496704-iukz?utm_source=share&utm_medium=member_desktop&rcm=ACoAAFRr3s0BqxrX5Ub5RpNmesdbcHMBVgfzN10"
    },
    {
      id: 2,
      ...
      projectDemoLinkdine:"https://www.linkedin.com/posts/oussama-ait-mohamed-239402336_daezveloppementweb-laravel-reactjs-activity-7336102076525010946-5b5k?utm_source=share&utm_medium=member_desktop&rcm=ACoAAFRr3s0BqxrX5Ub5RpNmesdbcHMBVgfzN10"
    },
    {
      id: 3,
      ...
      projectDemoLinkdine:"https://github.com/Oussamma642/contact-management-system"
    },
  ];
                          ...
                          <div className="flex flex-col justify-center items-center h-full max-w-full">
                            ...
                            <div className="flex gap-4">
                              <div className="w-6 h-6 text-white hover:text-indigo-400 transition-colors duration-200">
                               ...
                               <div className="w-6 h-6 text-white hover:text-indigo-400 transition-colors duration-200">
                                <a href={project.projectDemoLinkdine} target="_blank" rel="noopener noreferrer">
