        ...
        >
          {/* Project Image */}
              ...
              <div className="w-full lg:w-1/2">
                ...
                >
                  <div className="relative overflow-visible rounded-lg bg-slate-800 border border-slate-700 hover:border-indigo-500 transition-colors duration-300">
                    <img
                      src={project.image}
                      alt={project.title}
                      className="w-full h-auto object-contain filter blur-sm md:blur-none transition-transform duration-300 group-hover:scale-105"
                    />
